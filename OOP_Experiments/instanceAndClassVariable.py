# class variable is for all objects
# instance variable is for only specific object
...
class Student:
    ...
    def __init__(self,name,marks,age):
        ...
        self.marks=marks
    #methods
    def show_affiliation(self):
        #class variable, common for every object
    ...
    def get_grade(self):
        ...
        elif self.marks>=Student.passing_marks: return "Grade C"
        else : return "Fail"
...
print("Student1 : ")
stu1.show_affiliation()

#object cannot modify class variable
stu1.college="UCER"
stu1.show_affiliation()

#if you want to change value of class variable, access variable through ClassName
Student.college="UCER"
stu1.show_affiliation()